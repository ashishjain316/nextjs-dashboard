...
export function CustomersTableRowSkeleton() {
    return (
        <tr className="w-full border-b border-gray-100 last-of-type:border-none [&:first-child>td:first-child]:rounded-tl-lg [&:first-child>td:last-child]:rounded-tr-lg [&:last-child>td:first-child]:rounded-bl-lg [&:last-child>td:last-child]:rounded-br-lg">
        {/* Customer Name and Image */}
            <td className="relative overflow-hidden whitespace-nowrap py-5 pl-6 pr-3">
                <div className="flex items-center gap-3">
...
export function CustomersMobileSkeleton() {
    return (
        <div className="mb-2 w-full rounded-md bg-white p-4 py-5">
            <div className="flex-col items-center justify-between border-b border-gray-100 pb-4">
                <div className="mb-2 flex items-center gap-3">
                    <div className="mr-2 h-[28px] w-[28px] rounded-full bg-gray-100"></div>
                    <div className="h-5 w-16 rounded bg-gray-100"></div>
                </div>
            ...
            <div className="flex w-full items-center justify-between border-b border-gray-100 py-5">
                <div className="flex w-1/2 flex-col">
                    ...
                    <div className="mt-2 h-5 w-16 rounded bg-gray-100"></div>
                </div>
                <div className="flex w-1/2 flex-col">
                    <div className="h-3 w-12 rounded bg-gray-100"></div>
                    <div className="mt-2 h-5 w-16 rounded bg-gray-100"></div>
